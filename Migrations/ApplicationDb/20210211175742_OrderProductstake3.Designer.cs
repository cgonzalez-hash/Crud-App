...
namespace crud_app_take2.Migrations.ApplicationDb
{
    ...
    [Migration("20210211175742_OrderProductstake3")]
    partial class OrderProductstake3
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("crud_app_take2.Models.ApplicationUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("crud_app_take2.Models.CartProduct", b =>
                {
            ...
            modelBuilder.Entity("crud_app_take2.Models.Discount", b =>
                {
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("crud_app_take2.Models.ApplicationUser", null)
                        .WithMany()
